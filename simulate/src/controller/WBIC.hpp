...
public:
    ...
    void WBIC_solve_problem(unsigned int& dof, Eigen::VectorXd& Fr,OsqpEigen::Solver& solver);
    ...
    std::vector<Eigen::VectorXd> WBIC_getCtr();
...
private:
    ...
    Eigen::VectorXd tau;
    std::vector<Eigen::VectorXd> motor_cmd;
